var canComm = (function () {
    var methods = {};
    methods.ipCanv = function (d) {
        var COLOR = d.color || "#1E9FFF";
        //从页面获取IP
        // var MESSAGE = document.getElementById("title-desktop").textContent;
        var MESSAGE = d.ip || "www.cnki.net";
        var FONT_SIZE = 100;
        var AMOUNT = 3600;
        var SIZE = 2;
        ...
        function resizeCanvas() {
            ...
            canvas.width = d.boxW || window.innerWidth;
            canvas.height =d.boxH || window.innerHeight;
        }
